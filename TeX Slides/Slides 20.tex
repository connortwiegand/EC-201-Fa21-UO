...
\begin{frame}{The Rules of the Game}
	\begin{itemize}[<+->]
		...
		\begin{itemize}
			...
			\begin{itemize}
				\item I don't think this video is the best example of this, but it is an interesting proof of concept: \href{https://youtu.be/98TQv5IAtY8}{Green-Eyed Islander Puzzle}
			\end{itemize}
		\end{itemize}
	\end{itemize}
\end{frame}
